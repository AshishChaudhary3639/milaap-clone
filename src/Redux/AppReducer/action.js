...
const getDonate = () => (dispatch) => {
  ...
  return axios
    .get("https://creepy-seal-dungarees.cyclic.app/donate")
    .then((r) => {
...
export const getLendData = () => (dispatch) => {
  ...
  axios
    .get("https://creepy-seal-dungarees.cyclic.app/lendData")
    .then((r) => {
...
export const getinTheHomeData = (payload) => (dispatch) => {
  ...
  return axios
    ...
    .get(`https://creepy-seal-dungarees.cyclic.app/donate?q=${payload}&_limit=6`)
    .then((r) => {
